...
const endpoints = [
  ...
  { method: 'POST', path: '/api/v1/rt/queue/1/approve', body: {}, expect: [401] },
  { method: 'POST', path: '/api/v1/rt/queue/1/skip', body: {}, expect: [401] },
  { method: 'POST', path: '/api/v1/campaigns/1/sync', body: {}, expect: [401] },
  { method: 'POST', path: '/api/v1/campaigns/keyword', body: {}, expect: [401] },
  { method: 'GET', path: '/api/v1/campaigns/1/engagements?brand_id=1', expect: [401] },
