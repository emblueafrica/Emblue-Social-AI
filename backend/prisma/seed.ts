...
async function main(): Promise<void> {
  ...
  const messageSeed: {
    ...
    { platform: Platform.instagram, kind: 'comment', text: 'The new oat latte is the best coffee I have had this month.', handle: 'mariaeatsnyc', sentiment: Sentiment.positive, intent: Intent.praise, urgency: 2, topics: ['product love', 'coffee'], day: 6, metrics: { likes: 124, replies: 8 } },
    { platform: Platform.x, kind: 'mention', text: 'Still waiting on my refund from Emblue Demo Cafe. Support said 24 hours and it has been three days.', handle: 'jayneedshelp', sentiment: Sentiment.negative, intent: Intent.complaint, urgency: 5, topics: ['refund', 'support'], day: 6, metrics: { likes: 19, replies: 6, reposts: 4 } },
    { platform: Platform.tiktok, kind: 'comment', text: 'Do you ship cold brew packs outside Lagos?', handle: 'nifemidrinks', sentiment: Sentiment.neutral, intent: Intent.inquiry, urgency: 3, topics: ['shipping', 'cold brew'], day: 5, metrics: { likes: 44, replies: 2 } },
    { platform: Platform.instagram, kind: 'comment', text: 'Came for the latte art, stayed for the playlist. Whole vibe.', handle: 'lagosfoodie', sentiment: Sentiment.positive, intent: Intent.praise, urgency: 1, topics: ['ambience'], day: 5, metrics: { likes: 88, replies: 3 } },
    { platform: Platform.facebook, kind: 'mention', text: 'My discount code would not apply at checkout — a bit annoying.', handle: 'adunni.so', sentiment: Sentiment.negative, intent: Intent.complaint, urgency: 4, topics: ['discount', 'checkout'], day: 4, metrics: { likes: 7, replies: 5 } },
    { platform: Platform.x, kind: 'mention', text: 'Honestly the fastest support reply I have had from a cafe brand.', handle: 'tunde_lagos', sentiment: Sentiment.positive, intent: Intent.praise, urgency: 2, topics: ['support'], day: 4, metrics: { likes: 31, replies: 2 } },
    { platform: Platform.tiktok, kind: 'comment', text: 'Is there a student discount?', handle: 'streetbrew', sentiment: Sentiment.neutral, intent: Intent.inquiry, urgency: 2, topics: ['discount'], day: 3, metrics: { likes: 12, replies: 1 } },
    { platform: Platform.instagram, kind: 'comment', text: 'App keeps crashing when I try to reorder. Please fix.', handle: 'oluwa.fin', sentiment: Sentiment.negative, intent: Intent.complaint, urgency: 4, topics: ['bug', 'app'], day: 3, metrics: { likes: 9, replies: 4 } },
    { platform: Platform.facebook, kind: 'comment', text: 'Do you cater for office events?', handle: 'kemiwears', sentiment: Sentiment.neutral, intent: Intent.inquiry, urgency: 3, topics: ['catering'], day: 2, metrics: { likes: 5, replies: 2 } },
    { platform: Platform.x, kind: 'mention', text: 'Cold brew delivery arrived early and still cold. Impressed.', handle: 'coffeehunter', sentiment: Sentiment.positive, intent: Intent.praise, urgency: 1, topics: ['delivery', 'cold brew'], day: 2, metrics: { likes: 26, replies: 1 } },
    { platform: Platform.instagram, kind: 'comment', text: 'Second time my order was late this week.', handle: 'nene_pr', sentiment: Sentiment.negative, intent: Intent.complaint, urgency: 4, topics: ['late delivery'], day: 1, metrics: { likes: 14, replies: 6 } },
    { platform: Platform.tiktok, kind: 'comment', text: 'Tell me why this is the cleanest cafe aesthetic on my feed.', handle: 'bimbowears', sentiment: Sentiment.positive, intent: Intent.praise, urgency: 1, topics: ['ambience'], day: 1, metrics: { likes: 203, replies: 11 } },
    { platform: Platform.instagram, kind: 'comment', text: 'What time do you open on Sundays?', handle: 'luxe.ng', sentiment: Sentiment.neutral, intent: Intent.inquiry, urgency: 2, topics: ['opening hours'], day: 0, metrics: { likes: 4, replies: 1 } },
    { platform: Platform.x, kind: 'mention', text: 'Best coffee near the island, no debate.', handle: 'chinwe.code', sentiment: Sentiment.positive, intent: Intent.praise, urgency: 1, topics: ['best coffee'], day: 0, metrics: { likes: 57, replies: 3 } },
  ];
    ...
    data: kpiTrend.map((point, index) => {
      ...
      return {
        ...
        kpis: [
          ...
          { label: 'Avg response time', value: `${14 - index}m`, delta: -6 - index },
          { label: 'Conversion rate', value: `${(11 + index * 0.6).toFixed(1)}%`, delta: Number((2 + index * 0.3).toFixed(1)) },
        ],
        alerts: [
          { severity: 'high', message: 'Refund complaints need a visible response playbook.' },
    ...
    data: [
      {
        ...
        platform: Platform.x,
        authorHandle: '@jayneedshelp',
        originalText: 'Still waiting on my refund from Emblue Demo Cafe. Support said 24 hours and it has been three days.',
      ...
      },
      {
        ...
        originalText: 'I have been trying to reach your team for 3 days and no one is responding. Really frustrating.',
        replyText: 'Hi Kemi — that wait is on us and it should never take this long. Could you DM your account details so we can fix this personally?',
        confidence: 58,
        status: ApprovalStatus.pending,
      },
      {
        ...
        replyText: 'Sorry about that! We have reset your code — try again and let us know if it still does not apply.',
        confidence: 84,
        status: ApprovalStatus.pending,
      },
      {
        ...
        replyText: 'We are shipping a fix this week — DM us your device info and we will keep you posted.',
        confidence: 62,
        status: ApprovalStatus.pending,
      },
      {
        ...
        replyText: 'Checking your order right now — we will get back to you with a delivery update within the hour.',
        confidence: 77,
        status: ApprovalStatus.pending,
      },
      {
        ...
        replyText: 'That is twice too many — we are crediting your account and reviewing the delivery route today.',
        confidence: 69,
        status: ApprovalStatus.pending,
      },
      {
        ...
        platform: Platform.instagram,
        authorHandle: '@mariaeatsnyc',
        originalText: 'The new oat latte is the best coffee I have had this month.',
        replyText: 'Thanks for the love, Maria! The oat latte is available all week.',
        confidence: 96,
        status: ApprovalStatus.approved,
      },
    ],
  ...
  const engagementSeed: {
    ...
    { platform: Platform.instagram, handle: 'nifemidrinks', original: 'Do you ship cold brew packs outside Lagos?', reply: 'Yes, we ship nationwide. Check the link for delivery windows.', status: 'sent', day: 0 },
    { platform: Platform.instagram, handle: 'coffeehunter', original: 'Need this for my office fridge.', reply: 'We can help with office packs. Sending details by DM.', status: 'queued', day: 0 },
    { platform: Platform.instagram, handle: 'bimbowears', original: 'Is the oat latte available all week?', reply: 'Yes! The oat latte is on all week — come through.', status: 'sent', day: 1 },
    { platform: Platform.facebook, handle: 'adunni.so', original: 'My discount code is not applying.', reply: 'We reset your code — try again and tell us if it sticks.', status: 'sent', day: 1 },
    { platform: Platform.facebook, handle: 'lagosfoodie', original: 'Do you cater for events?', reply: 'We do! Share your date and headcount and we will quote you.', status: 'manual_copy', day: 2 },
    { platform: Platform.x, handle: 'jayneedshelp', original: 'Still waiting on my refund.', reply: 'Apologies for the wait — DM your order number and we will resolve it today.', status: 'sent', day: 2 },
    { platform: Platform.x, handle: 'tunde_lagos', original: 'Any update on my order? 5 days now.', reply: 'Checking your order now — we will update you within the hour.', status: 'queued', day: 3 },
    { platform: Platform.tiktok, handle: 'oluwa.fin', original: 'Why does the app keep crashing on iOS?', reply: 'A fix ships this week — DM your device info and we will keep you posted.', status: 'manual_copy', day: 3 },
    { platform: Platform.tiktok, handle: 'streetbrew', original: 'Do you have a student discount?', reply: 'Yes — 10% off with a student email. Tap the link to claim it.', status: 'sent', day: 4 },
    { platform: Platform.instagram, handle: 'kemiwears', original: 'Loved the launch event!', reply: 'Thank you, Kemi! So glad you came through.', status: 'sent', day: 5 },
  ];
